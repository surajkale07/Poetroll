...
import 'package:myapp/page-1/wishes_card.dart';
...
class _WishesState extends State<Wishes> {
  ...
  Future<void> fetchData() async {
    final response = await http
        .get(Uri.parse('https://www.poetroll.com/webservices/list-wishes.php'));
            ...
            : GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    ...
                    child: WishesCard(
                      backgroundImage: NetworkImage(poem['thumb']),
                      title: poem['title'],
                      poem_id: poem['id'],
                      video_url: poem['video_path'],
                    ),
                  );
                },
              ),
