...
class Talenthunt extends StatefulWidget {
  @override
  State<Talenthunt> createState() => _TalenthuntState();
}

class _TalenthuntState extends State<Talenthunt> {
  ...
  Future<void> fetchData() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (data['data'] != null && data['data']['TalentHunt'] is List) {
        setState(() {
          poemData =
              List<Map<String, dynamic>>.from(data['data']['TalentHunt']);
          filteredPoemData =
              List.from(poemData); // Initialize filtered data with all data
          isLoading = false;
        });
      } else {
